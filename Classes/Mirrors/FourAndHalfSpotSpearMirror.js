...
export default class FourAndHalfSpotSpearMirror extends BaseMirror {
    constructor(ctx, width, height, countX,upperSpearHeight, padding = 0) {
        ...
        this.spearHeight= height - 2 * this.lozengeHeight - 2* upperSpearHeight;
        this.drawer.addOneRowOfShapes(0, 0, new UpperSpear(this.lozengeWidth, upperSpearHeight , padding), countX);
        this.addGridOfLozenge(upperSpearHeight-this.lozengeHeight/2,this.lozengeWidth,this.lozengeHeight,countX,2,padding);
        this.drawer.addOneRowOfShapes(0, upperSpearHeight+this.lozengeHeight*1.5 , new Spear(this.spearWidth, this.spearHeight, padding), countX);
        this.addGridOfLozenge(this.spearHeight+upperSpearHeight+this.lozengeHeight/2,this.lozengeWidth,this.lozengeHeight,countX,2,padding);
