...
export default class HexagonalMirror extends BaseMirror {
    ...
    constructor(ctx, width, height, params, padding = 0) {
        ...
        let a = (-2 * this.hexWidth + Math.sqrt(16 * this.hexWidth ** 2 + 12 * this.hexHeight ** 2 )) / 6
        console.log(this.hexWidth,this.hexHeight,a)
        this.squareWidth = a;//this.hexWidth - 2 * a;
        let countX = Math.round(width / (this.hexWidth + this.squareWidth))
