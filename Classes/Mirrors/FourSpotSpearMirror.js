...
export default class FourSpotSpearMirror extends BaseMirror {
  constructor(ctx, width, height, params, padding = 0) {
    ...
    this.drawer.addOneRowOfShapes(
      0,
      0,
      new UpperTriangle(this.lozengeWidth, this.lozengeHeight / 2, padding),
      params.countX
    );
    ...
    this.drawer.addOneRowOfShapes(
      0,
      2 * this.lozengeHeight,
      new Spear(this.spearWidth, this.spearHeight, padding),
      params.countX
    );
    this.addGridOfLozenge(
      this.spearHeight + this.lozengeHeight,
      this.lozengeWidth,
      this.lozengeHeight,
      params.countX,
      2,
    ...
    this.drawer.addOneRowOfShapes(
      ...
      new BottomTriangle(this.lozengeWidth, this.lozengeHeight / 2, padding),
      params.countX
    );
  }
  ...
  drawMeasures(ctx, params, size = 0.8) {
    ...
    let hf = new UpperTriangle(
      this.lozengeWidth,
      this.lozengeHeight / 2,
      this.padding
    );
